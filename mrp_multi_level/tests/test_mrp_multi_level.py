...
class TestMrpMultiLevel(TestMrpMultiLevelCommon):
    ...
    def test_34_procure_wizard_mrp_action_override_to_buy(self):
    ...
    def test_35_procure_wizard_onchange_sets_vendor_currency(self):
    ...
    def test_36_stock_rule_make_po_domain_and_prepare_po_currency(self):
    ...
    def test_37_procure_item_onchange_uom_planned_order(self):
    ...
    def test_38_procure_item_onchange_uom_inventory_to_procure(self):
    ...
    def test_39_get_rule_respects_mrp_action(self):
    ...
    def test_40_procure_item_onchange_uom_fallback_original_qty(self):
    ...
    def test_41_procure_wizard_mrp_action_override_to_manufacture(self):
    ...
    def test_42_procure_wizard_mrp_action_override_to_pull(self):
    ...
    def test_43_procure_wizard_mrp_action_override_to_pull_push(self):
    ...
    def test_44_stock_rule_currency_domain_coverage(self):
    ...
    def test_45_procure_wizard_onchange_and_make_procurement_validations(self):
        planned = self.planned_order_obj.search(
            [("product_id", "=", self.pp_1.id)], limit=1
        )
        self.assertTrue(planned)
    ...
    def test_46_grouped_procurement_multiple_actions(self):
